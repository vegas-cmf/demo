    ...
    <div class="well">
        ...
        <div class="row widget">
            ...
            <div class="col-xs-4">
                ...
                <div class="controls-row">
                    <label>{{ form.get('raw_password').getLabel() }}</label>

                    {% if form.hasMessagesFor(form.get('raw_password').getName()) %}
                    <span class="help-block">
                        {% for error in form.getMessagesFor(form.get('raw_password').getName()) %}
                            {{ error }}
                        {% endfor %}
                    </span>
                    {% endif %}

                    {{ form.get('raw_password') }}
                </div>
                <div class="controls-row">
